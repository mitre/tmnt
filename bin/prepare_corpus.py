...
parser.add_argument('--tst_input_dir', type=str, help='Directory of test files (json batches)')
...
parser.add_argument('--tst_vec_file', type=str, help='Output file with test documents in sparse vector format')
