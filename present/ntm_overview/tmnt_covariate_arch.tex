...
\node[circle,draw,gray,fill=green!60,below=20pt of A5] (Q1) {~~~};
...
\node[circle,draw,gray,fill=green!60,below=20pt of Z3] (R1) {~~~};
...
\node[label={${\bf c}$},gray,thick,rounded corners,fill=gray!10,fit=(Q1)] (QQ1) {};
\node[label={${\bf c}$},gray,thick,rounded corners,fill=gray!10,fit=(R1)] (RR1) {};
\end{scope}

\node[circle,draw,black,right=40pt of D1] (P1) {${\bf *}$};
\node[rectangle, draw, red, below=60pt of Z3] (EPS) {$\epsilon \sim \mathcal{N}(0,1)$};
