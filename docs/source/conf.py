...
import os
import sys
sys.path.insert(0, os.path.abspath('./tmnt'))
...
latex_documents = [
    (master_doc, 'TMNT.tex', 'TMNT Documentation',
     'Ben Wellner', 'manual'),
]
...
man_pages = [
    (master_doc, 'tmnt', 'TMNT Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TMNT', 'TMNT Documentation',
     author, 'TMNT', 'One line description of project.',
     'Miscellaneous'),
]
