...
#from tmnt.data_loading import prepare_bert, prepare_bert_via_json
...
tr_dataset, dev_dataset, num_examples, bert_base = get_bert_datasets(class_labels,
                                                                     ...
                                                                     dataset, batch_size, 8, seq_len, pad)

estimator = FullyLabeledSeqEstimator(bert_base, len(class_labels))

estimator.fit_with_validation(tr_dataset, dev_dataset)
